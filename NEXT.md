...
All six phases built. 442 tests, 1 skipped, all offline. Running on the demo
...
```bash
python3 -m pytest                             # 442 tests, no network, no cookies
...
| `tests/` | 442 tests, 1 skipped, no network, no cookies, plus a golden Moment timeline. |
